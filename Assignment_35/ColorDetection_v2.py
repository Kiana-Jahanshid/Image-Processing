...
upper = {'red':(186,255,255) , 'green':(86,255,255)  , 'blue':(117,255,255) , 'yellow':(54,255,255) , 'orange':(20,255,255), 'purple':(224,176,255) , 'white':(255, 255, 255), 'purple':(30, 30, 30)}
colors= {'red':(0,0,255)     , 'green':(0,255,0)     , 'blue':(255,0,0)     , 'yellow':(0, 255, 217), 'orange':(0,140,255) , 'purple':(128, 0, 128) , 'white':(255, 255, 255), 'purple':(0, 0, 0)}
